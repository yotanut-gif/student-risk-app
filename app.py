...
def ensure_session_state() -> None:
    ...
    if "bottom_save_success" not in st.session_state:
        st.session_state.bottom_save_success = False
...
def main() -> None:
    ...
    if st.button("บันทึกข้อมูล"):
        ...
        st.session_state.bottom_save_success = True
        reload_students(grade, room)
        st.rerun()

    if st.session_state.bottom_save_success:
        st.success("บันทึกข้อมูลสำเร็จ")
        st.session_state.bottom_save_success = False
